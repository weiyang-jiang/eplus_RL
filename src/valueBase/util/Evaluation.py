...
class ResultParser(object):
    def __init__(self, working_dir):
        ...
        try:
            ...
            self.baseline_name = "rl_parametric_part1_pit_light"
        self.baseline = BASELINE[self.baseline_name]
        self.energy_dict_data = None
        self.comfort_dict_data = None
    ...
    def compare(self):
        ...
        self.energy_dict_data = energy_dict_data
        self.comfort_dict_data = comfort_dict_data
        energy_list = []
        comfort_list = []
        env_list = []
