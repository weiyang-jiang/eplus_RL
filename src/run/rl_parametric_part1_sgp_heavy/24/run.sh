...
--env Part1-Heavy-Sgp-Train-v1 `# 训练环境的名称(training environment name)` \
...
--test_env Part1-Heavy-Sgp-Test-v1 Part1-Heavy-Sgp-Test-v2 Part1-Heavy-Sgp-Test-v3 Part1-Heavy-Sgp-Test-v4 `# 测试环境名称(test environment name)` \
