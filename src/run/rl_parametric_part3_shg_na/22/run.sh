...
--env Part3-NA-Shg-Train-v1 `# 训练环境的名称(training environment name)` \
...
--test_env Part3-NA-Shg-Test-v1 Part3-NA-Shg-Test-v2 Part3-NA-Shg-Test-v3 Part3-NA-Shg-Test-v4 `# 测试环境名称(test environment name)` \
