...
--env Part1-Medium-Bej-Train-v1 `# 训练环境的名称(training environment name)` \
...
--test_env Part1-Medium-Bej-Test-v1 Part1-Medium-Bej-Test-v2 `# 测试环境名称(test environment name)` \
