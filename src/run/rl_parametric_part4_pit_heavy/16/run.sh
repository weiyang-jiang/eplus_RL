...
--env Part4-Heavy-Pit-Train-Repeat-v2 `# 训练环境的名称(training environment name)` \
...
--test_env Part4-Heavy-Pit-Test-Repeat-v3 Part4-Heavy-Pit-Test-Repeat-v4 `# 测试环境名称(test environment name)` \
