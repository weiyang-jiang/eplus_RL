...
--env Part2-Light-Bej-Train-v1 `# 训练环境的名称(training environment name)` \
...
--action_space part2_v3 `# 动作的大小(action space)` \
--test_env Part2-Light-Bej-Test-v1 Part2-Light-Bej-Test-v2 Part2-Light-Bej-Test-v3 Part2-Light-Bej-Test-v4 `# 测试环境名称(test environment name)` \
