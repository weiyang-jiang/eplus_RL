...
--env Part3-NA-Sgp-Train-v1 `# 训练环境的名称(training environment name)` \
...
--test_env Part3-NA-Sgp-Test-v1 Part3-NA-Sgp-Test-v2 Part3-NA-Sgp-Test-v3 Part3-NA-Sgp-Test-v4 `# 测试环境名称(test environment name)` \
