...
--env Part2-Light-Shg-Train-v1 `# 训练环境的名称(training environment name)` \
...
--test_env Part2-Light-Shg-Test-v1 Part2-Light-Shg-Test-v2 Part2-Light-Shg-Test-v3 Part2-Light-Shg-Test-v4 `# 测试环境名称(test environment name)` \
