...
--feature DQN_v1_35 `# 此次训练的自定义特征名称：如使用rainbow方法采用rewardv1奖励时[rainbow_v1](The custom feature for this training)` \
--method DQN `# 此次训练的方法(Algorithm for this training)` \
...
--env Part1-Light-Pit-Train-v1 Part1-Light-Pit-Test-v1 `# 训练环境的名称(training environment name)` \
