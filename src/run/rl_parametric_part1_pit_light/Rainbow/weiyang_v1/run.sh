...
--feature Asynrainbow_weiyangv1_test `# 此次训练的自定义特征名称：如使用rainbow方法采用rewardv1奖励时[rainbow_v1](The custom feature for this training)` \
...
--is_on_server True --is_test True `# 此次执行是否为测试功能(is test or not)`