...
--dir_path rl_parametric_part1_pit_light/Rainbow_weiyang_v1/weiyang_v1_newEP46_shuffle/Eplus-env-Asyn_Train_environment-Asynrainbow_weiyangv1_35_newEP46_shuffle-res1 `# ` \
--model_name rainbow_weiyangv1_35_shuffle `# 模型保存的名称 ` \
