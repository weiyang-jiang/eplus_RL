...
--env Part2-Light-Pit-Train-v1 `# 训练环境的名称(training environment name)` \
...
--test_env Part2-Light-Pit-Test-v1 Part2-Light-Pit-Test-v2 Part2-Light-Pit-Test-v3 Part2-Light-Pit-Test-v4 `# 测试环境名称(test environment name)` \
