...
--dir_path rl_parametric_part1_pit_light/Rainbow/weiyang_v1/Eplus-env-Part1-Light-Pit-Train-v1-rainbow_weiyangv1_35-res1 `# ` \
--model_name rainbow_weiyangv1_35 `# 模型保存的名称 ` \
--feature rainbow_weiyangv1_35 `# 此次训练的自定义特征名称：如使用rainbow方法采用rewardv1奖励时[rainbow_v1](The custom feature for this training)` \
